...
#ifndef NOPASSSDKREACT_SWIFT_H
#define NOPASSSDKREACT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NoPassSDKReact",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface Account (SWIFT_EXTENSION(NoPassSDKReact))
...
@interface AuthHistory (SWIFT_EXTENSION(NoPassSDKReact))
...
SWIFT_CLASS("_TtC14NoPassSDKReact14NetworkManager")
@interface NetworkManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC14NoPassSDKReact18NoPassConfigurator")
...
SWIFT_CLASS("_TtC14NoPassSDKReact15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(NoPassSDKReact)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(NoPassSDKReact)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(NoPassSDKReact)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(NoPassSDKReact)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(NoPassSDKReact)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC14NoPassSDKReact12TaskDelegate")
